...
SECRET_KEY = 'django-insecure-bx#j@qhd8x+uj&r^9a386i30zunbwx1s8qc2bosczvz=^vjvqo'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
REDIS_URL = os.environ.get('REDIS_URL_PROD', 'redis://localhost:6379')


ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    os.environ.get("RENDER_EXTERNAL_HOSTNAME", "travel-app-5kt2.onrender.com")
]
